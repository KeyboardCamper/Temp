...
const int8_t button1Pin = A2; //LEFT 
const int8_t button2Pin = A1; //RIGHT
const int8_t button3Pin = A0; //UP
const int8_t button4Pin = A3; //DOWN 
const int8_t button5Pin = 0; //A
const int8_t button6Pin = 7; //B
const int8_t button7Pin = 8; //MENU

const int8_t sound = 4; 
bool sound_enabled=true;
//const int8_t ledPin = 10; 

int8_t button1State = 1;
int8_t button2State = 1;
int8_t button3State = 1;
int8_t button4State = 1;
int8_t button5State = 1;
int8_t button6State = 1;
int8_t button7State = 1;
...
//  pinMode(ledPin, OUTPUT);
  ...
  randomSeed(analogRead(0)+readVcc());
  display.begin();
...
void displayIndicators(uint8_t font){
  //speaker
  display.drawLine(56,1,56,6,font);
  display.drawLine(55,1,55,6,font);
  display.drawLine(54,2,54,5,font);
  display.drawLine(53,3,53,4,font);
  display.drawLine(52,3,52,4,font);
  if(sound_enabled){
    display.drawPixel(58,2,font);
    display.drawPixel(59,3,font);
    display.drawPixel(59,4,font);
    display.drawPixel(58,5,font);
  }
  //...
}
